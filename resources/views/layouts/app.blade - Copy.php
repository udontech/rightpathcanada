...
<head>
    ...
    {{-- favicon --}}
    <link rel="shortcut icon" href="{{ asset('image/logoo.png') }}" type="image/x-icon">
        ...
        <div class="container-fluid row p-md-5 py-3 px-4">
            ...
            <div class="col-lg-4 col-md-8 my-3 custom-footer-item0">
                ...
                <p class="text-light text-justify">
                                        Right Path Canada is committed to helping individuals achieve their dream of living in Canada and to provide them with
            ...
            <div class="col-lg-4 col-md-8 my-5 mb-2 mb-lg-5 custom-footer-item2">
                ...
                <p><i class="fa-solid fa-phone"></i> +xxxxxxxxxxx</p>
            </div>
